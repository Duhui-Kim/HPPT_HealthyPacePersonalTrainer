...
public class LikeBoardController {
	...
	@ApiOperation(value = "{userId}가 {boardId}를 좋아요 눌렀는지 체크", notes = "0이면 누르지 않았고, 1 이상이면 눌렀음")
	...
	@PostMapping
	@ApiOperation(value = "게시글 좋아요 누르는 method 입니다", notes = "userId와 boardId를 입력받아야 합니다")
	...
	@DeleteMapping
	@ApiOperation(value = "게시글 좋아요 취소하는 method 입니다", notes = "userId와 boardId를 입력받아야 합니다")
